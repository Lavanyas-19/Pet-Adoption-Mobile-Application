...
## Installation & Setup
1. Backend API Setup
The backend manages pet listings and adoption requests.
cd pet-adoption-api
pip install -r requirements.txt
# Running with --host 0.0.0.0 is required for mobile device access
uvicorn app:app --host 0.0.0.0 --port 8000
2. Mobile Client Setup
Ensure you have the Expo Go app installed on your physical device to test.
cd PetAdoptionApp
npm install
npx expo start
...
To Install: Download the .apk on your Android device and select "Install Anyway" if prompted by system security.
